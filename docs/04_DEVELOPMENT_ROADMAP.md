...
- SP-00.04: Next.js portal App base setup
- SP-00.05: Next.js Admin App base setup
- SP-00.06: Next.js setup App base setup
- SP-00.07: Next.js docs App base setup
- SP-00.08: API Proxy & CORS Configuration  
...
> _Copy and paste these exact prompts to the AI to execute development._
...
```text
TASK ID: SP-00.04
PHASE / SUB-PHASE: 00 — Scaffold & Hello World / 00.04 Next.js portal App base setup

CONTEXT:
You are building a premium Enterprise IAM Platform. Read docs/01_CONSTITUTION.md through docs/13_ARCHITECTURE_DECISION_RECORDS.md. Architecture must strictly follow the UI -> Hook -> TanStack Query -> API Client flow. Never use inline fetch or axios in components.

TASK:
Design and implement the engineering requirements for: Next.js portal App base setup.
...
```text
TASK ID: SP-00.05
PHASE / SUB-PHASE: 00 — Scaffold & Hello World / 00.05 Next.js Admin App base setup
...
```text
TASK ID: SP-00.06
PHASE / SUB-PHASE: 00 — Scaffold & Hello World / 00.06 Next.js setup App base setup

CONTEXT:
You are building a premium Enterprise IAM Platform. Read docs/01_CONSTITUTION.md through docs/13_ARCHITECTURE_DECISION_RECORDS.md. Architecture must strictly follow the UI -> Hook -> TanStack Query -> API Client flow. Never use inline fetch or axios in components.

TASK:
Design and implement the engineering requirements for: Next.js setup App base setup.
...
```text
TASK ID: SP-00.07
PHASE / SUB-PHASE: 00 — Scaffold & Hello World / 00.07 Next.js docs App base setup

CONTEXT:
You are building a premium Enterprise IAM Platform. Read docs/01_CONSTITUTION.md through docs/13_ARCHITECTURE_DECISION_RECORDS.md. Architecture must strictly follow the UI -> Hook -> TanStack Query -> API Client flow. Never use inline fetch or axios in components.

TASK:
Design and implement the engineering requirements for: Next.js docs App base setup.
...
```text
TASK ID: SP-00.08
PHASE / SUB-PHASE: 00 — Scaffold & Hello World / 00.08 API Proxy & CORS Configuration
