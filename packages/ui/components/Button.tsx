...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-brand-700 disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-brand-400",
  {
    variants: {
      variant: {
        default:
          "bg-brand-600 text-white shadow hover:bg-brand-600/90 dark:bg-brand-500 dark:text-white dark:hover:bg-brand-500/90",
        destructive:
